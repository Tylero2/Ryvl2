...
function Button({ children, className = "", variant = "default", href = "#", ...props }) {
  ...
  return (
    <a className={cx(base, variants[variant] || variants.default, className)} href={href} {...props}>
      {children}
    </a>
  );
}
    ...
    <div className="min-h-screen overflow-hidden bg-[#05070b] text-white">
      ...
      <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-blue-400/40 bg-white/5 shadow-lg shadow-blue-500/10">
            <span className="text-xl font-black tracking-tight text-white">R</span>
          </div>
          <div>
            <p className="text-lg font-bold tracking-tight">Ryvl Marketing</p>
        ...
        <Button href="#pilot" className="rounded-2xl px-5 text-white">Book a Call</Button>
      </header>
        ...
        <section className="mx-auto grid max-w-7xl items-center gap-12 px-6 pb-20 pt-12 md:grid-cols-[1.05fr_.95fr] md:pb-28 md:pt-20">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300 md:text-xl">
              Ryvl Marketing helps local businesses and personal brands strengthen their online presence through audits, content systems, lead tracking, and growth strategy.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Button href="#pilot" className="h-12 rounded-2xl px-6 text-base font-semibold text-white">
          ...
          <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-blue-600/25 via-white/[0.06] to-black/30 p-8 md:p-12">
            <div className="grid gap-10 md:grid-cols-[.95fr_1.05fr] md:items-center">
              <div>
                ...
                <Button href="mailto:hello@ryvlmarketing.com" className="mt-7 h-12 rounded-2xl bg-white px-6 text-base font-bold text-slate-950 hover:bg-blue-50">
      ...
      <footer className="relative z-10 border-t border-white/10 px-6 py-10">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 text-sm text-slate-400 md:flex-row md:items-center md:justify-between">
          <p>© 2026 Ryvl Marketing. Built for modern brands.</p>
          <div className="flex gap-5">
            <a href="#services" className="hover:text-white">Services</a>
            <a href="#pilot" className="hover:text-white">Free Audit</a>
            <a href="mailto:hello@ryvlmarketing.com" className="hover:text-white">Contact</a>
          </div>
        </div>
      </footer>
    </div>
