  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#05070b] text-white">
      ...
      <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
        ...
        <Button href="#pilot" className="rounded-2xl px-5">Book a Call</Button>
      </header>
        ...
        <section className="mx-auto grid max-w-7xl items-center gap-12 px-6 pb-20 pt-12 md:grid-cols-[1.05fr_.95fr] md:pb-28 md:pt-20">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Button href="#pilot" className="h-12 rounded-2xl px-6 text-base font-semibold">
          ...
          <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-blue-600/25 via-white/[0.06] to-black/30 p-8 md:p-12">
            <div className="grid gap-10 md:grid-cols-[.95fr_1.05fr] md:items-center">
              <div>
                ...
                <Button href="mailto:hello@ryvlagency.com?subject=Free Marketing Audit Request" variant="light" className="mt-7 h-12 rounded-2xl px-6 text-base font-bold shadow-lg shadow-black/20">
